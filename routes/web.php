...
Route::middleware(['admin'])->group(function () {
    ...
    Route::post('/admin/toko/setujui/{id}', [TokoController::class, 'setujui'])->name('member.setujui.toko');
    Route::post('/admin/toko/tolak/{id}', [TokoController::class, 'tolak'])->name('member.tolak.toko');
